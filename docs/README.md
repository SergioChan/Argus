...
- **Every artifact needs a signed current C3 ValidationReport.** No output carries a claim tier above `ran-toy` without a signature-valid report from an S3 verifier key; verify signatures at every consumption point.
