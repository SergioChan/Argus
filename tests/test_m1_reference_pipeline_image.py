    ...
    def test_prepare_reference_pipeline_image_binds_the_built_compose_service_id(self) -> None:
                ...
                return CompletedProcess(
                    ...
                    "\n".join(
                        (
                            ...
                            "argus-m0-s10-reference-model-provider",
                            "argus-m0-s10-reference-security-pager",
        ...
        self.assertEqual(
            ...
            [
                ...
                ["docker", "image", "tag", expected_image_id, "argus-m0-s10-reference-model-provider"],
                ["docker", "image", "tag", expected_image_id, "argus-m0-s10-reference-security-pager"],
