...
class S8PostgresSchemaTests(unittest.TestCase):
    ...
    def test_ledger_writer_can_insert_records_edges_and_closure(self) -> None:
        self._psql(
            """
            ...
            VALUES ('c4://artifact/a', 'c4://artifact/b', 'input', 'training_data');
        ...
        result = self._psql("SELECT count(*) FROM s8.artifact_record;")
