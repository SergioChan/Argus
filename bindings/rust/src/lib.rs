...
pub const CONTRACTS: &[Contract] = &[
    ...
    Contract { id: "C6", name: "Compute Adapter Tool Interface", owner: "S7", version: "1.1.0", schema: "c6.compute-adapter.schema.json", schema_sha256: "sha256:1d1a9c4051b0eb8ab2c7ad8edc345aa40450313b3614858620dcb680f652e2f7", consumers: &["S1", "S2", "S3", "S5", "S6", "S10", "S11", "S12"] },
];
