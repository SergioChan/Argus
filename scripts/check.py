...
CHECKS = (
    ...
    (
        ...
        (
            ...
            "scripts/generate_s10_gvisor_monitor_config.py",
            "scripts/gvisor_security_probe.py",
            ...
            "src/argus_egress/__init__.py",
            "src/argus_runtime/m1_reference_runtime.py",
            "src/argus_runtime/m1_pilot_console.py",
            "src/argus_runtime/m1_reference_service_auth.py",
            "src/argus_runtime/s2_reference_builder_service.py",
            "src/argus_runtime/s2_isolated_training_entrypoint.py",
            "src/argus_runtime/s3_frozen_pipeline_entrypoint.py",
            "src/argus_runtime/s3_profile_registry.py",
            "src/argus_runtime/s3_reference_referee_service.py",
            ...
            "src/argus_runtime/s8_persistence.py",
            "src/argus_runtime/s10_egress_proxy_service.py",
            "src/argus_runtime/s10_reference_security_pager_service.py",
            "src/argus_runtime/s10_security_monitor_client.py",
            "src/argus_runtime/s10_supervisor_service.py",
            "src/argus_runtime/s1_reference_demo_service.py",
            "src/argus_runtime/s7_reference_adapter_service.py",
            "src/argus_runtime/s11_reference_observatory_service.py",
            "src/argusverify/__init__.py",
            "tests/test_s3_blind_data_manager.py",
            "tests/test_s3_calibration_check_plugin.py",
            "tests/test_s3_claim_tiering_rule_engine.py",
            "tests/test_s3_check_plugin_host.py",
            "tests/test_s3_cross_code_check_plugin.py",
            "tests/test_s3_frozen_pipeline_runner.py",
            "tests/test_s3_frozen_pipeline_entrypoint.py",
            ...
            "tests/test_s3_reference_referee_service.py",
            "tests/test_m1_reference_lifecycle_services.py",
            "tests/test_m1_pilot_console.py",
            ...
            "tests/test_s10_image_verification.py",
            "tests/test_s10_egress_proxy.py",
            "tests/test_s10_forensic_quarantine.py",
            "tests/test_s10_reference_security_pager.py",
            "tests/test_s10_security_monitor.py",
        ),
    ),
)
